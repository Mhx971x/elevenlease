...
create table if not exists public.invoice_settings (
  ...
  legal_status text not null default 'DJAFFAR Mehdi – Entrepreneur individuel / micro-entreprise',
  address_line1 text default '60 rue François 1er',
  address_line2 text,
  postal_code text default '75008',
  city text default 'Paris',
  country text not null default 'France',
  siren text default '931 287 908',
  registration_number text not null default '931 287 908 00020',
  rcs text,
